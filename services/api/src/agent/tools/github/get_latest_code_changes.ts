...
export default async function (integration: GithubIntegration) {
  ...
  return new DynamicStructuredTool({
    ...
    description: `Get latest code changes in a repo's main branch, given a repository full name. Available repositories are (in the format of Repo name: {org}/{repo} Repo description: {description}): ${reposInfo.join(
      "\n\n",
    )}`,
